/* Auth:                                                     hydramin */
/* Date:                                 Tue Nov 20 22:47:39 EST 2018 */
/*--Break--*/
...
??"minind";
/*--Break--*/
bx = mk_fmat(1..3,1..3,[[1,2,3],[4,5,6],[7,8,9]]);
/*--Break--*/
by = bx[1..2,1..2] - 1;
/*--Break--*/
inner_prtMat(by);
...
/*--Break--*/
G = mk_fmat(1..9,1..2,[
[12.5,3],[15.5,3],[18.5,3],
[12.5,0],[15.5,0],[18.5,0],
[12.5,-3],[15.5,-3],[18.5,-3]
]);
/*--Break--*/
??"proj_";
/*--Break--*/
point = mk_fvec(1..2,[16.99,-3.1]);
proj_minDistIndex(point,G);
/*--Break--*/
